...
### プレイヤーの回復効果
execute as @a[scores={HealCount=1..3},nbt=!{active_effects:[{id:"minecraft:regeneration"}]}] run function tusb_remake:player/heal/small
execute as @a[scores={HealCount=4..},nbt=!{active_effects:[{id:"minecraft:instant_health"}]}] run function tusb_remake:player/heal/large
