...
execute if data storage tusb_cw: {potion_barrier:[{id:"minecraft:instant_damage",amplifier:10b}]} run data modify storage tusb_cw: potion_barrier set value true
...
execute if data storage tusb_cw: {potion_barrier:[{id:"minecraft:instant_damage",amplifier:29b}]} run data modify storage tusb_cw: potion_barrier set value true
