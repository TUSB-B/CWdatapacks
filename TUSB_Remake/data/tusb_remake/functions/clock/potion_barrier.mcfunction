...
execute if data storage tusb_cw: {potion_barrier:[{id:"instant_health"b,Amplifier:10b}]} run data modify storage tusb_cw: potion_barrier set value true
execute if data storage tusb_cw: {potion_barrier:[{id:"instant_health"b,Amplifier:10b}]} run data modify storage tusb_cw: potion_barrier set value true
execute if data storage tusb_cw: {potion_barrier:[{id:"instant_health"b,Amplifier:29b}]} run data modify storage tusb_cw: potion_barrier set value true
execute if data storage tusb_cw: {potion_barrier:[{id:"instant_health"b,Amplifier:29b}]} run data modify storage tusb_cw: potion_barrier set value true
