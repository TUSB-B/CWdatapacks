...
### 受けたダメージを設定
data modify storage score_damage: Argument set value {EPF:0,Damage:0.00d,DamageType:"None",BypassArmor:true,BypassResistance:true,DisableParticle:true}
execute store result storage score_damage: Argument.Damage double 0.0025 run scoreboard players get _ TUSB
