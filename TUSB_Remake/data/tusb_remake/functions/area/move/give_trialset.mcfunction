...
### お試しセットを渡す
give @s minecraft:ghast_spawn_egg{display:{Name:'"§bお試しセットの印玉"',Lore:['"§rモードスキル用お試しセットが入っている。"','"§rなくなったら交易島のアルバイトから買おう。"']},Enchantments:[{}],EntityTag:{id:"minecraft:bat",DeathTime:19s,active_effects:[{id:instant_damage,duration:100,amplifier:5b,show_particles:false},{id:invisibility,duration:100,amplifier:0b,show_particles:false}],Tags:[RewardEgg,TypeChecked],DeathLootTable:"usb:signs/skillkit"},CanPlaceOn:["#minecraft:all"],HideFlags:16}
