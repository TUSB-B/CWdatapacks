...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#tusb_remake:mob,tag=Enemy,nbt=!{active_effects:[{Id:23}]}] at @s run function tusb_remake:skill/summoner/gold_basin/schedule/hit
