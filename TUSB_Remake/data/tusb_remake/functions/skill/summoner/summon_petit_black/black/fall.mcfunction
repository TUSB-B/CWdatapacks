...
execute positioned ~-0.5 ~1 ~-0.5 as @e[dy=0,type=#tusb_remake:mob,tag=Enemy,nbt=!{active_effects:[{id: "minecraft:saturation"}]}] at @s run function tusb_remake:skill/summoner/summon_petit_black/black/hit
