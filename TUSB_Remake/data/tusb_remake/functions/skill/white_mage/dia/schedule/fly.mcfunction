...
# CW変更点：範囲化
execute as @e[distance=..5,type=#tusb_remake:mob,tag=Enemy,nbt=!{active_effects:[{id: "minecraft:saturation"}]}] at @s run function tusb_remake:skill/white_mage/dia/hit