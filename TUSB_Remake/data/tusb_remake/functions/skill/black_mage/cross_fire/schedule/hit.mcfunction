...
execute if entity @s[type=#tusb_remake:burnable,nbt=!{active_effects:[{id: "minecraft:fire_resistance"}]}] store result storage score_damage: Argument.Damage double 0.03 run data get storage score_damage: Argument.Damage 100
### ダメージを与える
