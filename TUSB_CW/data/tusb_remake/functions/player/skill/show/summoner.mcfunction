...
execute if score @s ShowSkill matches 6300 run data modify storage tusb_remake: skill_name set value "ぶちぶち"
execute if score @s ShowSkill matches 6310 run data modify storage tusb_remake: skill_name set value "サモン：ぷちブラック"
