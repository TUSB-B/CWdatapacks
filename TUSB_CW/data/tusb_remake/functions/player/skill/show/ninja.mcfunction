...
execute if score @s ShowSkill matches 2250 run data modify storage tusb_remake: skill_name set value "撒菱"
execute if score @s ShowSkill matches 2251 run data modify storage tusb_remake: skill_name set value "撒菱Ⅱ"
execute if score @s ShowSkill matches 2252 run data modify storage tusb_remake: skill_name set value "撒菱Ⅲ"
