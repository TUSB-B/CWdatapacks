...
execute if score @s ShowSkill matches 2220 run data modify storage tusb_remake: skill_name set value "撒菱"
execute if score @s ShowSkill matches 2221 run data modify storage tusb_remake: skill_name set value "撒菱Ⅱ"
execute if score @s ShowSkill matches 2222 run data modify storage tusb_remake: skill_name set value "撒菱Ⅲ"
execute if score @s ShowSkill matches 2230 run data modify storage tusb_remake: skill_name set value "跳躍"
execute if score @s ShowSkill matches 2231 run data modify storage tusb_remake: skill_name set value "跳躍Ⅱ"
execute if score @s ShowSkill matches 2232 run data modify storage tusb_remake: skill_name set value "跳躍Ⅲ"
execute if score @s ShowSkill matches 2240 run data modify storage tusb_remake: skill_name set value "居縮"
execute if score @s ShowSkill matches 2241 run data modify storage tusb_remake: skill_name set value "居縮Ⅱ"
execute if score @s ShowSkill matches 2250 run data modify storage tusb_remake: skill_name set value "サヨナラ"
