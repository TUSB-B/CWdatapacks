...
###### 島ギミック ########
## エンダーチェスト島のワープ
execute positioned 58 94 -103 as @e[dx=17,dy=2,dz=17,nbt=!{Passengers:[]}] at @s if block ~ ~-1 ~ #tusb_remake:stained_glass_and_pane run spreadplayers ~ ~ 1 300 under 319 false @s
## ホッパー島のワープ
