...
data modify storage tusb_remake: _.22 set value {name:["撒菱","撒菱Ⅱ","撒菱Ⅲ"],level:[7,27,47],cost:40,description:[["敵にダメージを与え、足を遅くする撒菱を放つ。"]],condition:"ニンジン付きの棒を持って右クリック",range:[3,4,5],duration:[10]}
data modify storage tusb_remake: _.23 set value {name:["跳躍","跳躍Ⅱ","跳躍Ⅲ"],level:[13,26,39],cost:3,description:[["スニーク時間に応じて跳躍力が上昇する。"]],condition:"スニークする",duration:[3]}
data modify storage tusb_remake: _.24 set value {name:["居縮","居縮Ⅱ"],level:[28,46],cost:10,description:[["敵単体をすくみ上がらせ、金縛り状態にする。"]],condition:"雪玉を投げる",duration:[5]}
