...
data modify storage tusb_remake: _.0 set value {name:["サモンP：スノー"],level:[5],cost:25,description:[["スノーゴーレム(ペット)を召喚する。","HP：✮✮✮✩✩","攻：✩✩✩✩✩","防：✮✮✩✩✩","特性：爆発耐性","支援：採掘速度上昇"]]}
data modify storage tusb_remake: _.1 set value {name:["サモンE：マーチャント"],level:[10],cost:30,description:[["商人を召喚する。"]]}
data modify storage tusb_remake: _.2 set value {name:["ヘイカモンα","ヘイカモンβ"],level:[13,33],cost:10,description:[["周囲のペットを５体まで引き寄せる。"],["周囲のペットを10体まで引き寄せる。"]],range:[15],sneak:{description:[["周囲のプレイヤーも１人まで引き寄せる。"],["周囲のプレイヤーも２人まで引き寄せる。"]],range:[15]}}
data modify storage tusb_remake: _.3 set value {name:["サモンE:スーパードラゴン"],level:[17],cost:35,description:[["スーパードラゴンを召喚する。"]]}
data modify storage tusb_remake: _.4 set value {name:["サモンP：ウルフ"],level:[25],cost:40,description:[["オオカミ(ペット)を召喚する。","HP：✮✮✮✩✩","攻：✮✮✮✮✮","防：✮✮✮✩✩","特性：火炎耐性","支援：攻撃力上昇"]]}
data modify storage tusb_remake: _.5 set value {name:["サモンE:ヒーリングキャット"],level:[30],cost:45,description:[["ぬこかわいいよぬこ。"]],duration:[10]}
...
data modify storage tusb_remake: _.20 set value {name:["フィールα","フィールβ","フィールγ"],level:[1,20,40],cost:30,description:[["自身の足元に5x5の羊毛の足場を召喚する。","アドベンチャーダンジョンでは使用できない。"],["自身の足元に7x7の羊毛の足場を召喚する。","アドベンチャーダンジョンでは使用できない。"],["自身の足元に9x9の羊毛の足場を召喚する。","アドベンチャーダンジョンでは使用できない。"]],condition:"ニンジン付きの棒を持って右クリック",sneak:{description:[["周囲のプレイヤーの足元に5x5の羊毛の足場を召喚する。"],["周囲のプレイヤーの足元に7x7の羊毛の足場を召喚する。"],["周囲のプレイヤーの足元に9x9の羊毛の足場を召喚する。"]],range:[15]}}
data modify storage tusb_remake: _.21 set value {name:["金タライ"],level:[3],cost:5,description:[["周囲の敵の頭上に金タライを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[15]}
...
data modify storage tusb_remake: _.30 set value {name:["ぶちぶち"],level:[47],cost:50,description:[["周囲のペットが真の力を発揮する"]],condition:"ニンジン付きの棒を持って右クリック",duration:[15]}
data modify storage tusb_remake: _.31 set value {name:["サモン:ぷちブラック"],level:[50],cost:100,description:[["ぷちブラックホールを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック",duration:[15]}
