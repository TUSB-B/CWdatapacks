...
execute if score _ ActivatedSkill matches 2230..2239 as @e[tag=skillsnowball,sort=nearest,limit=1] at @s run function tusb_remake:skill/ninja/isukumi/apply
execute if score _ ActivatedSkill matches 2250..2259 as @e[tag=skillsnowball,sort=nearest,limit=1] at @s run function tusb_remake:skill/ninja/makibisi/apply
