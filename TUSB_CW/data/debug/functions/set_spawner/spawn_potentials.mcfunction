...
# まず村人を乗せたentityを作る
data modify storage debug:set_spawner SpawnData set value {Silent:true,NoAI:true,DeathTime:19,Health:0f,loot_table:"empty",Passengers:[{id:"minecraft:marker",Tags:[Spawn],data:{AssetId:-1}}]}
...
# Idを設定する
data modify storage debug:set_spawner SpawnData.Passengers[0].data.AssetId set from storage debug:set_spawner _.SpawnMob[0].Id
