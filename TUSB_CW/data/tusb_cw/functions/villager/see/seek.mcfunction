...
# 村人にThisタグを付けてそれが付いている村人がいれば再帰終了
    ...
    # 村人がいないなら再帰
        execute if entity @s[distance=..8] unless entity @e[type=villager,tag=This,distance=..3] positioned ^ ^ ^0.1 run function tusb_cw:villager/see/seek