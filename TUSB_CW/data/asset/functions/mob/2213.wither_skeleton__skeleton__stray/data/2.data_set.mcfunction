#> asset:mob/2213.wither_skeleton__skeleton__stray/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2213
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "minecraft:iron_sword", Count: 1b, tag: {display: {Name: '{"text":"名剣「粉骨砕身」","color":"red"}'}, Enchantments: [{lvl: 3s, id: "minecraft:fire_aspect"}]}}
        # オフハンド
