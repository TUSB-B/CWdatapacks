#> asset:mob/4211.mahyouju/data/2.data_set
...
data modify storage asset: mob set value {Passengers:[{CustomName:'{"text":"魔氷樹"}',Passengers:[{Passengers:[{Particle:"block lime_terracotta",Radius:4.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:236}]},{Passengers:[{Particle:"block lime_wool",Radius:3.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:236}]},{Passengers:[{Particle:"block cactus",Radius:2.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:236}]},{DisplayOffset:-16,RequiredPlayerRange:17s,CustomDisplayTile:1b,MaxNearbyEntities:6,SpawnCount:3,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,Delay:1,SpawnData:{entity:{NoGravity:1b,Passengers:[{CustomName:'{"text":"肉食果実"}',RabbitType:99,Health:50.0f,Attributes:[{Base:0.8d,Name:"generic.movement_speed"},{Base:50.0d,Name:"generic.max_health"},{Base:50.0d,Name:"generic.attack_damage"}],DeathLootTable:"empty",id:"rabbit",Tags:["enemy"],active_effects:[{Duration:3600,id:wither,amplifier:0b}]}],Value:-1000,id:"experience_orb",Age:80}},id:"spawner_minecart",MaxSpawnDelay:100s,SpawnRange:8s,MinSpawnDelay:50s},{DisplayOffset:-32,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-48,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-64,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-80,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-96,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-112,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-128,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-144,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-160,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-176,CustomDisplayTile:1,DisplayTile:{"block":{Name:"birch_log"}},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-192,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],Health:1000.0f,Attributes:[{Base:1000.0d,Name:"generic.max_health"},{Base:80.0d,Name:"generic.attack_damage"},{Base:1.0d,Name:"generic.knockback_resistance"}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}],Tags:["SkillMob","WarpOnly","leap"]}],Health:0.0f,DeathTime:19s,id:"villager",active_effects:[{show_particles:0b,Duration:20,id:invisibility,amplifier:0b}]}
...
# data modify storage asset: mob set value {Passengers:[{CustomName:'{"text":"魔樹"}',Passengers:[{Passengers:[{Particle:"iconcrack",ParticleParam2:5,ParticleParam1:159,Radius:4.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:128}]},{Passengers:[{Particle:"iconcrack",ParticleParam2:5,ParticleParam1:35,Radius:3.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:128}]},{Passengers:[{Particle:"iconcrack",ParticleParam2:0,ParticleParam1:81,Radius:2.5f,Duration:999,id:"area_effect_cloud",effects:[{Duration:200,id:jump_boost,amplifier:128}]},{DisplayOffset:-16,RequiredPlayerRange:17s,CustomDisplayTile:1b,SpawnCount:3s,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1s,SpawnData:{NoGravity:1b,Passengers:[{CustomName:'{"text":"肉食果実"}',RabbitType:99,Health:20.0f,Attributes:[{Base:0.8d,Name:"generic.movement_speed"},{Base:20.0d,Name:"generic.max_health"},{Base:20.0d,Name:"generic.attack_damage"}],DeathLootTable:"empty",id:"Rabbit",Tags:["enemy"],active_effects:[{Duration:3600,id:wither,amplifier:0b}],CustomNameVisible:1}],Value:-1000,id:"experience_orb",Age:80},id:"spawner_minecart",MaxSpawnDelay:50s,SpawnRange:8s,MinSpawnDelay:20s},{DisplayOffset:-32,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-48,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-64,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-80,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-96,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-112,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-128,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-144,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-160,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-176,CustomDisplayTile:1,DisplayTile:{"block":{Name:"birch_log"}},Invulnerable:1,id:"spawner_minecart"},{DisplayOffset:-192,CustomDisplayTile:1,DisplayState:{Name:"minecraft:birch_wood"},Invulnerable:1,id:"spawner_minecart"}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}]}],Health:800.0f,Attributes:[{Base:800.0d,Name:"generic.max_health"},{Base:40.0d,Name:"generic.attack_damage"},{Base:1.0d,Name:"generic.knockback_resistance"}],id:"enderman",active_effects:[{Duration:3600,id:invisibility,amplifier:0b}],Tags:["SkillMob","WarpOnly","leap"]}],Health:0.0f,DeathTime:19s,id:"villager",active_effects:[{show_particles:0b,Duration:20,id:invisibility,amplifier:0b}]}
...
# data modify storage asset: mob.Attributes[{Name:generic.max_health}] append value {Modifiers:[{Amount:1,Operation:0,UUID:[I;158,58721857,885,8867183],Name:"example_modifier"}]}
...
# item replace entity @e[tag=ItemHolder,limit=1] weapon.offhand with shield{Damage:86} 1
...
#effect一覧
    ...
    #{Name:jump_boost,id:8} 跳躍力上昇 1.8*(lv*0.5)
