#> asset:mob/4804.spetsnaz/data/2.data_set
...
data modify storage asset: mob set value {Profession:0,Passengers:[{Health:1000.0f,Attributes:[{Base:0.8d,Name:"generic.movement_speed"},{Base:250,Name:"generic.attack_damage"},{Base:99,Name:"generic.follow_range"},{Base:1000,Name:"generic.max_health"}],CustomName:'{"text":"Спецназ"}',Passengers:[{CustomName:'{"text":"SVDS Dragunov"}',Health:500.0f,ArmorItems:[{},{},{},{id:"iron_helmet",Count:65b}],Attributes:[{Base:300,Name:"generic.attack_damage"},{Base:99,Name:"generic.follow_range"},{Base:500,Name:"generic.max_health"},{Base:0.7d,Name:"generic.knockback_resistance"}],Silent:1,PersistenceRequired:1,id:"guardian",Tags:["FloatingRequired"],active_effects:[{show_particles:0b,Duration:1200000,id:fire_resistance,amplifier:0},{show_particles:0b,Duration:1200000,id:invisibility,amplifier:127}]}],ArmorItems:[{id:"iron_boots",Count:65b,tag:{Enchantments:[{lvl:10,id:protection},{lvl:10,id:projectile_protection},{lvl:5,id:depth_strider}]}},{},{},{}],PersistenceRequired:1,id:"spider",Tags:["AbyssWarp","SkillMob","CanFire","PaleRiderR","akuu"],Team:"Boss",active_effects:[{Duration:1200000,id:fire_resistance,amplifier:2},{show_particles:0b,Duration:1200000,id:glowing,amplifier:0}],CustomNameVisible:1}],DeathTime:19s,Health:0.0f,id:"villager"}
