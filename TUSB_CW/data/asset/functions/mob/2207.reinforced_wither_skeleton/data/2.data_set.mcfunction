#> asset:mob/2207.reinforced_wither_skeleton/data/2.data_set
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id:"netherite_sword",Count:1b,AttributeModifiers:[]}
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id:"netherite_sword",Count:1b,AttributeModifiers:[]}
    # 防具
        # 頭
