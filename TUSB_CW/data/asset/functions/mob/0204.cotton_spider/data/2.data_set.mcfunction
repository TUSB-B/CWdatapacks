#> asset:mob/0204.cotton_spider/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{CustomName: '{"text":"綿蜘蛛"}', Passengers: [{FallDistance: 1.0f, HurtEntities: 1b, BlockState: {Name: "minecraft:cobweb"}, FallHurtMax: 30, Block: "minecraft:web", Time: 1, id: "minecraft:falling_block", FallHurtAmount: 30.0f, DropItem: 0b}, {Item: {Count: 1b, id: "minecraft:splash_potion", tag: {custom_potion_effects: [{show_particles: 0b, duration: 180, id: "minecraft:slowness", amplifier: 4b}, {show_particles: 0b, duration: 180, id: "minecraft:mining_fatigue", amplifier: 4b}, {show_particles: 1b, duration: 180, id: "minecraft:levitation", amplifier: -10b}], Potion: "minecraft:water"}}, Potion: {Count: 1b, id: "minecraft:splash_potion", tag: {custom_potion_effects: [{show_particles: 0b, duration: 180, id: "minecraft:slowness", amplifier: 4b}, {show_particles: 0b, duration: 180, id: "minecraft:mining_fatigue", amplifier: 4b}, {show_particles: 1b, duration: 180, id: "minecraft:levitation", amplifier: -10b}], Potion: "minecraft:water"}}, id: "minecraft:potion"}, {Particle: "end_rod", Radius: 0.05f, ReapplicationDelay: 0, CustomName: '{"text":"綿毛"}', RadiusOnUse: 0.0f, Duration: 999, id: "minecraft:area_effect_cloud", effects: []}], Health: 60.0f, Attributes: [{Base: 200.0d, Name: "generic.max_health"}, {Base: 0.25d, Name: "generic.movement_speed"}, {Base: 10.0d, Name: "generic.attack_damage"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 32.0d, Name: "generic.follow_range"}], id: "minecraft:cave_spider"}], DeathTime: 19s, Health: 0.0f, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
