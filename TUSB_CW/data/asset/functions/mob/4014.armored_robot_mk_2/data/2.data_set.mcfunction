#> asset:mob/4014.armored_robot_mk_2/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4014
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"Armored Robot Mk.2"}'
    # 名前を表示するか
...
### Attributes
    ...
    # 移動速度
        data modify storage asset: mob.Attributes append value {Name:generic.movement_speed, Base:0.345}
    # 防具値
    ...
    # ノックバック耐性(0~1)
        data modify storage asset: mob.Attributes append value {Name:generic.knockback_resistance, Base:0.7}
    # 索敵範囲
...
### アイテム
    ...
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id: "gold_block", Count:65b}
        # 胴
