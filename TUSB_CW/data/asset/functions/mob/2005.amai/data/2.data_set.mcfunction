#> asset:mob/2005.amai/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2005
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"甘いものには裏がある","color":"light_purple","bold":true}'
    # 名前を表示するか
...
# 死亡時ポーションを乗せる(即時ダメージ３，空腹１)
    data modify storage asset: mob.Passengers append value {CustomNameVisible:1b,id:"minecraft:potion",CustomName:'{"text":"甘いものには裏がある","color":"light_purple","bold":true}',Item:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionColor:6168524,custom_potion_effects:[{id:"minecraft:instant_damage",amplifier:2b,duration:1}]}}}
