#> asset:mob/2208.ghost_sniper/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2208
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"ゴーストスナイパー","color":"dark_aqua"}'
    # 名前を表示するか
...
### active_effects
    ...
    data modify storage asset: mob.Passengers[0].HandItems[0] set value {id: "minecraft:bow", Count: 1b, tag: {display: {Name: '{"text":"ゴーストスナイパー","color":"dark_aqua"}'}}}
