#> asset:mob/4020.master_chef/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4020
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"Master Chef"}'
    # 名前を表示するか
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "iron_sword", Count: 65b, tag: {Enchantments: [{id: "fire_aspect", lvl: 255}], AttributeModifiers: []}}
        # オフハンド
            # data modify storage asset: mob.HandItems[1] set value {}
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id: "leather_helmet", Count: 65b, tag: {display: {color: 16777215}}}
        # 胴
            data modify storage asset: mob.ArmorItems[2] set value {id: "leather_chestplate", Count: 65b, tag: {display: {color: 16777215}}}
        # 脚
            data modify storage asset: mob.ArmorItems[1] set value {id: "leather_leggings", Count: 65b, tag: {display: {color: 16777215}}}
        # 足
            data modify storage asset: mob.ArmorItems[0] set value {id: "leather_boots", Count: 65b, tag: {display: {color: 16777215}}}
...
# 死亡時ポーション
    data modify storage asset: mob.Passengers append value {id: "potion", Item: {id: "minecraft:splash_potion", Count: 1b, tag: {CustomPotionColor: 0, custom_potion_effects: [{id: "minecraft:nausea", amplifier: 0b, duration: 300},{id: "minecraft:hunger", amplifier: 126b, duration:6000}]}}}