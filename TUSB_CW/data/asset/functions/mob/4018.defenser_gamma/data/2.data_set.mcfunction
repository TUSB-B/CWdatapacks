#> asset:mob/4018.defenser_gamma/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4018

### idを設定
    data modify storage asset: mob.id set value "iron_golem"
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"拠点防衛装置γ"}'
    # 名前を表示するか
