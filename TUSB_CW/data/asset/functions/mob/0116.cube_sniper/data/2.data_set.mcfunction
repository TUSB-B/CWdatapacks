#> asset:mob/0116.cube_sniper/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Attributes: [{Base: 10.0d, Name: "generic.attack_damage"}], id: "minecraft:magma_cube", Passengers: [{Healtf: 200.0f, CustomName: '{"text":"キューブスナイパー"}', ArmorItems: [{id: "minecraft:leather_boots", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}]}}, {id: "minecraft:leather_leggings", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}]}}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}]}}, {id: "minecraft:netherrack", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}]}}], Attributes: [{Base: 200.0d, Name: "generic.max_health"}], id: "minecraft:skeleton", HandItems: [{id: "minecraft:bow", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, Enchantments: [{lvl: 2s, id: "minecraft:power"}, {lvl: 1s, id: "minecraft:flame"}]}}]}], AbsorptionAmount: 50s, Size: 2}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
