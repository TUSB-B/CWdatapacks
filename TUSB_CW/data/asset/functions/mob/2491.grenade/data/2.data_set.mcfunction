#> asset:mob/2491.grenade/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2491

### idを設定
    data modify storage asset: mob.id set value "slime"

### 体力等nbtを設定
    # 体力
        data modify storage asset: mob.Health set value 5
    # 緩衝体力
        data modify storage asset: mob.AbsorptionAmount set value 5
    # AIを持っていないか
    ...
    # デスポーンしないか
      ...
      # 名前
        data modify storage asset: mob.CustomName set value '{"text":"グレネード","bold":true,"color":"dark_green"}'
    # 名前を表示するか
    ...
    # サイズ
       data modify storage asset: mob.Size set value 1
...
### active_effects
    ...
    data modify storage asset: mob.Passengers append value {Fuse: 1s, powered: 0b, CustomName: '{"text":"グレネード","bold":true,"color":"dark_green"}', Health: 5.0f, Attributes: [{Base: 5.0d, Name: "generic.max_health"}, {Base: 1.5d, Name: "generic.movement_speed"}], id: "minecraft:creeper", ExplosionRadius: 2b, CustomNameVisible: 1b}