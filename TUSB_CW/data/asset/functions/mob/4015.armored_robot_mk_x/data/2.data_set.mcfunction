#> asset:mob/4015.armored_robot_mk_x/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4015
...
### Attributes
    ...
    # (近接)攻撃力
        data modify storage asset: mob.Attributes append value {Name:generic.attack_damage, Base:30}
    # 移動速度
    ...
    # ノックバック耐性(0~1)
        data modify storage asset: mob.Attributes append value {Name:generic.knockback_resistance, Base:1.0}
    # 索敵範囲
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "netherite_sword", Count:65b}
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id: "netherite_axe", Count:65b}
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id: "diamond_block", Count:65b}
        # 胴
            data modify storage asset: mob.ArmorItems[2] set value {id: "netherite_chestplate", Count:65b}
        # 脚
            data modify storage asset: mob.ArmorItems[1] set value {id: "netherite_leggings", Count:65b}
        # 足
            data modify storage asset: mob.ArmorItems[0] set value {id: "netherite_boots", Count:65b}
