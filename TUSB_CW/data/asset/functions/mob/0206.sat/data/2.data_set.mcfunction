#> asset:mob/0206.sat/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{CustomName: '{"text":"10式0.3m小銃"}', Health: 60.0f, Attributes: [{Base: 100.0d, Name: "generic.max_health"}, {Base: 32.0d, Name: "generic.follow_range"}, {Base: 10.0d, Name: "generic.attack_damage"}], Silent: 1b, id: "minecraft:guardian", active_effects: [{show_particles: 0b, duration: 2147483647, id: "minecraft:fire_resistance", amplifier: 0b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:invisibility", amplifier: 0b}]}], CustomName: '{"text":"SAT"}', Health: 60.0f, Attributes: [{Base: 60.0d, Name: "generic.max_health"}, {Base: 32.0d, Name: "generic.follow_range"}, {Base: 5.0d, Name: "generic.attack_damage"}, {Base: 0.4d, Name: "generic.movement_speed"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 12.0d, Name: "generic.armor"}], id: "minecraft:cave_spider", Tags: ["CanSpin"], CustomNameVisible: 1b}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
