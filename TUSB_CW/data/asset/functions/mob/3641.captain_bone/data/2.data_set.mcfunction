#> asset:mob/3641.captain_bone/data/2.data_set
...
# 体力等nbtを設定(コメントアウトを解除して設定)
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"§l§fボーン船長"}'
    # 名前を表示するか
...
# アイテム
    ...
    # 武器
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id:flint_and_steel,Count:1b,display: {Name: '{"text":"§l§fボーン船長の鉤爪"}'},Damage: 0,Unbreakable: 1b}
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id:stone_sword,Count:1b,display: {Name: '{"text":"§l§fボーン船長のサーベル"}'},Enchantments: [{lvl: 1s, id: "minecraft:knockback"}], Damage: 0,Unbreakable: 1b}
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id:player_head,Count:1b,tag:{SkullOwner: {Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjI2NmZiNzYwYjA3ZTA3NDEzZGVjMjI1MzVlY2ExOTE5ZTdjM2ZkYTE2ZmMxNzgzZmUwNTllZTg2Yzc1NGQyZSJ9fX0="}], Id: [I;978341650,-1928376394,-1687334588,110413711]},display: {Name: '{"text":"§l§fボーン船長の頭蓋骨"}'}}}}
        # 胴
            data modify storage asset: mob.ArmorItems[2] set value {id:golden_chestplate,Count:1b,Unbreakable: 1b}
        # 脚
            data modify storage asset: mob.ArmorItems[1] set value {id:golden_leggings,Count:1b,Unbreakable: 1b}
        # 足
            data modify storage asset: mob.ArmorItems[0] set value {id:golden_boots,Count:1b,Unbreakable: 1b}
...
# active_effects
    ...
    data modify storage asset: mob.Passengers append value {\
        ...
        CustomName:'{"text":"§l§fボーン船長","bold":true}',\
        CustomNameVisible:1b,\
        DisplayState: {Name: "coal_block"},\
        Invulnerable: 1b,\
        Tags: ["RidingRequired"],\
        Delay: -1,\
        MinSpawnDelay: 200,\
