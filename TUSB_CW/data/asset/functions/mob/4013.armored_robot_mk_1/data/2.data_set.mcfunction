#> asset:mob/4013.armored_robot_mk_1/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4013
...
### 体力等nbtを設定
    # 体力
        data modify storage asset: mob.Health set value 350
    # 緩衝体力
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"Armored Robot Mk.1"}'
    # 名前を表示するか
...
### Attributes
    ...
    # (近接)攻撃力 2+8
        data modify storage asset: mob.Attributes append value {Name:generic.attack_damage, Base:2}
    # 移動速度
        data modify storage asset: mob.Attributes append value {Name:generic.movement_speed, Base:0.23}
    # 防具値
        data modify storage asset: mob.Attributes append value {Name:generic.armor, Base:-13}
    # 防具強度
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "iron_axe", Count:65b}
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id: "shield", Count:65b}
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id: "iron_block", Count:65b}
        # 胴
            data modify storage asset: mob.ArmorItems[2] set value {id: "iron_chestplate", Count:65b}
        # 脚
            data modify storage asset: mob.ArmorItems[1] set value {id: "iron_leggings", Count:65b}
        # 足
            data modify storage asset: mob.ArmorItems[0] set value {id: "iron_boots", Count:65b}
