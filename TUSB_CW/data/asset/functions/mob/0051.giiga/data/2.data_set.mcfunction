#> asset:mob/0051.giiga/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Particle: "portal", Radius: 1.5f, CustomName: '{"text":"メン"}', Duration: 1000, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 120, id: "minecraft:hunger", amplifier: 3b}, {show_particles: 1b, duration: 120, id: "minecraft:slowness", amplifier: 4b}]}], CustomName: '{"text":"ギーガ"}', VillagerProfession: 3, Health: 40.0f, ArmorItems: [{}, {}, {}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; 1728958448, 526863518, -1539253799, -1884504621], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGEzNmYxOWMzMDVjY2RiMzZlNDdiMmRhZGNmNTllNmFkOGRkOTNjZGY0NzQ4Nzc1ZDVhNmVjNDFlZDk3ZiJ9fX0="}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 1.0d, Name: "generic.movement_speed"}, {Base: 30.0d, Name: "generic.attack_damage"}], id: "minecraft:zombie", IsVillager: 1b, HandItems: [{}, {}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
