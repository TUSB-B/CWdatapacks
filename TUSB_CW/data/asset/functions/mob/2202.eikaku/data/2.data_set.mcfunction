#> asset:mob/2202.eikaku/data/2.data_set
...
# 名前
data modify storage asset: mob.CustomName set value '{"text":"bold":true,"color":"yellow","text":"鋭角様"}'
# 名前を表示するか
...
item replace entity @e[tag=ItemHolder,limit=1] armor.chest with leather_chestplate{Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:1s}],display:{color:16772608}} 1
item replace entity @e[tag=ItemHolder,limit=1] armor.legs with leather_leggings{Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:1s}],display:{color:16772608}} 1
...
#effect一覧
    ...
    # 詳しくはwiki見てね！
data modify storage asset: mob.active_effects append value {id:invisibility,amplifier:126,Duration:-1,show_particles:0b}
