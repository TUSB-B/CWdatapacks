#> asset:mob/2209.chocolate_sniper/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{id: "minecraft:skeleton",DeathLootTable:"empty",CustomNameVisible: 1b,Silent:1b,Health:50f,Passengers:[{id:"minecraft:area_effect_cloud",Tags:["RidingRequired"],Particle:"block dark_oak_trapdoor",Radius:0.5f,Duration:32767,CustomNameVisible: 1b,CustomName:'{"text":"チョコレートスナイパー","color":"#82330C","bold":true,"italic":false}'}],CustomName:'{"text":"チョコレートスナイパー","color":"#82330C","bold":true,"italic":false}',HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:'{"text":"チョコレートショット","color":"white","bold":true,"italic":false}',Lore:['{"text":"溶けるような甘さを貴方に","color":"red","bold":false,"italic":true}']},Enchantments:[{id:"minecraft:infinity",lvl:1s},{id:"minecraft:punch",lvl:20s},{id:"minecraft:unbreaking",lvl:1s}]}},{id:"minecraft:tipped_arrow",Count:64b,tag:{custom_potion_effects:[{id:"minecraft:slowness",amplifier:1b,duration:100},{id:"minecraft:instant_damage",amplifier:0b,duration:5},{id:"minecraft:nausea",amplifier:10b,duration:100},{id:"minecraft:saturation",amplifier:10b,duration:10},{id:"minecraft:levitation",amplifier:50b,duration:3}],CustomPotionColor:4663830}}],HandDropChances:[-327.670F,-327.670F],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:16711680}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:16711680}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5058312}}},{id:"minecraft:brown_concrete",Count:1b}],ArmorDropChances:[-327.670F,-327.670F,-327.670F,0.085F],Attributes:[{Name:generic.max_health,Base:50},{Name:generic.follow_range,Base:100}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"},id: "minecraft:villager"}
