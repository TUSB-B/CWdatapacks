#> asset:mob/0106.white_attacker/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{CustomName: '{"text":"ﾎﾜｲﾄｱﾀｯｶｰ"}', Health: 40.0f, ArmorItems: [{}, {}, {}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; 703315884, -1800319224, -2031452376, 954312125], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2FmMTEwMjRlY2Y5YWM5Yjc4OTQ3NWZmNGExMzVmNzFkYTA0MzJlYTlmZjY0YzE3ZWZlMzViMjkzMzRmZCJ9fX0="}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.0d, Name: "generic.knockback_resistance"}, {Base: 0.4d, Name: "generic.movement_speed"}, {Base: 20.0d, Name: "generic.attack_damage"}], id: "minecraft:wither_skeleton", active_effects: [{show_particles: 0b, duration: 100000, id: "minecraft:levitation", amplifier: -2b}, {show_particles: 0b, duration: 100000, id: "minecraft:jump_boost", amplifier: 1b}], HandItems: [{id: "minecraft:stone_sword", Count: 65b, tag: {Enchantments: [{lvl: 1s, id: "minecraft:fire_aspect"}], Damage: 0}}, {}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
