#> asset:mob/0243.eruption_ghast/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Passengers: [{Passengers: [{Passengers: [{RequiredPlayerRange: 48s, MaxNearbyEntities: 99s, CustomDisplayTile: 1b, SpawnCount: 2s, DisplayState: {Name: "minecraft:enchanting_table"}, DisplayTile: "minecraft:enchanting_table", Invulnerable: 1b, SpawnData: {}, MaxSpawnDelay: 1s, Delay: -1s, DisplayOffset: 8, CustomName: '{"text":"ダイフンカ"}', DeathLootTable: "empty", id: "minecraft:spawner_minecart", SpawnRange: 5s, MinSpawnDelay: 1s, SpawnPotentials: [{data: {entity: {Motion: [0.0d, -2.0d], HurtEntities: 1b, FallDistance: 0.0f, BlockState: {Properties: {level: "5"}, Name: "minecraft:lava"}, Passengers: [{Particle: "flame", Radius: 0.1f, ReapplicationDelay: 0, CustomName: '{"text":"マグマフォールオーラ"}', Duration: 40, id: "minecraft:area_effect_cloud", effects: []}, {ParticleParam2: 14, Particle: "minecraft:block air", Radius: 1.0f, ParticleParam1: 160, ReapplicationDelay: 0, CustomName: '{"text":"マグマフォール"}', RadiusOnUse: 0.0f, Duration: 30, id: "minecraft:area_effect_cloud", effects: [{duration: 6, Id: 12b, amplifier: 127b}, {duration: 60, Id: 15b, amplifier: 0b}, {duration: 140, Id: 19b, amplifier: 2b}]}, {id: "minecraft:ender_pearl"}], FallHurtMax: 40, Block: "minecraft:lava", Time: 1, id: "minecraft:falling_block", FallHurtAmount: 40.0f, DropItem: 0b}}, weight: 1}]}, {Particle: "dripping_lava", Radius: 0.05f, ReapplicationDelay: 0, CustomName: '{"text":"キャリアーオーラ"}', RadiusOnUse: 0.0f, Duration: 80, id: "minecraft:area_effect_cloud", effects: []}], CustomName: '{"text":"ガストキャリアー"}', Health: 100.0f, Attributes: [{Base: 100.0d, Name: "generic.max_health"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.0d, Name: "generic.follow_range"}], Silent: 1b, id: "minecraft:ghast", ExplosionPower: 0}], CustomName: '{"text":"ﾅﾋﾞｹﾞｰﾄ"}', Size: 5, Attributes: [{Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 80.0d, Name: "generic.follow_range"}], Silent: 1b, DeathLootTable: "empty", id: "minecraft:magma_cube", AbsorptionAmount: 80.0f, active_effects: [{duration: 2147483647, Id: 14b, amplifier: 127b}, {duration: 2147483647, Id: 25b, amplifier: -1b}, {duration: 2147483647, Id: 20b, amplifier: 0b}]}], CustomName: '{"text":"ﾗﾝﾀﾞﾑﾑｰﾊﾞｰ"}', Health: 5.0f, Attributes: [{Base: 5.0d, Name: "generic.max_health"}], Silent: 1b, id: "minecraft:bat", active_effects: [{duration: 2147483647, Id: 14b, amplifier: 127b}, {duration: 2147483647, Id: 20b, amplifier: 127b}]}], CustomName: '{"text":"不発弾"}', LifeTime: 30, Life: 2, id: "minecraft:firework_rocket"}], Health: 0.0f, DeathTime: 19s, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
