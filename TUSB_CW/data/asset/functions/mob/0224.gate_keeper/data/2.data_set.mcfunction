#> asset:mob/0224.gate_keeper/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Fuse: 1s, powered: 1b, CustomName: '{"text":"ゲートキーパー"}', Health: 20.0f, Attributes: [{Base: 20.0d, Name: "generic.max_health"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.4d, Name: "generic.movement_speed"}], id: "minecraft:creeper", ExplosionRadius: 5b, active_effects: [{show_particles: 0b, duration: 2000000000, id: "minecraft:jump_boost", amplifier: 1b}], CustomNameVisible: 1b}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
