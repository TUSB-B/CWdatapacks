#> asset:mob/3642.cube_sniper_revenge/data/2.data_set
...
data modify storage asset: mob set value {Passengers: \
[{Health: 1000.0f,\
active_effects:[{id: "minecraft:resistance",amplifier:126b,duration:-1,show_particles:0b}],\
DeathLootTable:"empty",Tags:[RiderRequired],\
Attributes: [\
                {Base: 1000.0f, Name: "generic.max_health"},\
                {Base: 80.0d, Name: "generic.follow_range"},\
                {Base: 15.0d, Name: "generic.attack_damage"}\
            ],\
CustomNameVisible:1b,\
CustomName: '{"text":"§k§0§lrevenge逆襲§r§lの§4キューブ§r§k§0§lrevenge§r"}',\
id: "minecraft:magma_cube", \
Passengers: [\
                {Health: 700.0f,\
                active_effects:[\
                                {id: "minecraft:fire_resistance",amplifier:0b,duration:-1,show_particles:0b}\
                               ],\
                CustomNameVisible:1b,\
                CustomName: '{"text":"§k§0§lrevenge逆襲§r§lの§4キューブスナイパー§r§k§0§lrevenge§r"}',\
                HandDropChances:[0.0F,0.0F],\
                ArmorDropChances:[0.0F,0.0F,0.0F,0.0F], \
                Tags:[RidingRequired],\
                ArmorItems: [\
                {id: "minecraft:leather_boots", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 127s, id: "minecraft:fire_protection"}]}},\
                {id: "minecraft:leather_leggings", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 127s, id: "minecraft:fire_protection"}]}},\
                {id: "minecraft:leather_chestplate", Count: 65b, tag: {RepairCost: 1000000000, Damage: 0, display: {color: 14483456}, Enchantments: [{lvl: 127s, id: "minecraft:fire_protection"}]}},\
                {id: "minecraft:netherrack", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 127s, id: "minecraft:fire_protection"}]}}],\
                Attributes: \
                    [\
                        {Base: 80.0d, Name: "generic.follow_range"},\
                        {Base: 700.0d, Name: "generic.max_health"},\
                        {Base: -30.0d, Name: "generic.armor"}\
                    ],\
                DeathLootTable:"empty",\
                id: "minecraft:skeleton",\
                HandItems: \
                        [\
                                {id: "minecraft:bow", Count: 65b,\
                                     tag: {RepairCost: 1000000000, Damage: 0, Enchantments: [\
                                        {lvl: 7s, id: "minecraft:power"},\
                                        {lvl: 10s, id: "minecraft:flame"}]}},\
                                {id:"minecraft:tipped_arrow",Count:64b,\
                                    tag:{display: {Name: '{"text":"魂を燃やす矢","color":"black"}'},\
                                    custom_potion_effects:[\
                                        {id:"minecraft:weakness",amplifier:2b,duration:80},\
                                        {id:"minecraft:slowness",amplifier:2b,duration:80},\
                                        {id:"minecraft:wither",amplifier:1b,duration:60}],\
                                    CustomPotionColor:11730944}}\
                        ]\
                }\
            ],\
        AbsorptionAmount: 50s, Size: 2}],\
Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
