#> asset:mob/2204.shulker_bullet/data/2.data_set
...
### 体力等nbtを設定
    # 体力
        data modify storage asset: mob.Health set value 180
    # 緩衝体力
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"シュルカーバレット"}'
    # 名前を表示するか
...
### Attributes
    # 最大体力
        data modify storage asset: mob.Attributes append value {Name:generic.max_health, Base:180}
    # (近接)攻撃力
...
### アイテム
    # アイテムのデータを入力します
        data modify storage asset: mob.HandItems set value [\
            {id:"minecraft:bow",Count:1b,tag:{Enchantments:[{id:"minecraft:power",lvl:8s},{id:"minecraft:punch",lvl:3s}]}},\
            {id:"minecraft:tipped_arrow",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:speed",amplifier:49b,duration:2},{id:"minecraft:levitation",amplifier:9b,duration:10}],CustomPotionColor:12419563}}]
        data modify storage asset: mob.ArmorItems set value [{},{},\
            {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:12419563}}},\
            {id:"minecraft:shulker_box",Count:1b}]
