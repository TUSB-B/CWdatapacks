#> asset:mob/4110.black_hole_generator/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Motion: [0.0d, -2.0d, 0.0d], MaxNearbyEntities: 32, RequiredPlayerRange: 7, CustomDisplayTile: 1b, SpawnCount: 2, DisplayState: {Name: "minecraft:crying_obsidian"}, Silent: 1b, Invulnerable: 1b, SpawnData: {entity: {Passengers: [{Particle: "portal", Radius: 0.7f, CustomName: '{"text":"ミニブラック","bold":true}', Duration: 600, id: "minecraft:area_effect_cloud", effects: [{show_particles: 0b, duration: 60, Id: 2, amplifier: 3b}, {show_particles: 0b, duration: 60, Id: 7, amplifier: 3b}, {show_particles: 0b, duration: 60, Id: 33, amplifier: 3b}]}], Health: 0.0f, Attributes: [{Base: 0, Name: "generic.max_health"}], Silent: 1b, id: "minecraft:villager", Tags: ["Garbage"]}}, MaxSpawnDelay: 20, Delay: 0, id: "minecraft:spawner_minecart", SpawnRange: 5, MinSpawnDelay: 60}], CustomName: '{"text":"ブラックホールジェネレーター","color":"black","bold":true,"italic":true,"underlined":true}', Health: 1000.0f, ArmorItems: [{}, {}, {id: "minecraft:netherite_chestplate", Count: 1b}, {}], Attributes: [{Base: 1000, Name: "generic.max_health"}, {Base: 30, Name: "generic.attack_damage"}, {Base: 20, Name: "generic.armor"}], id: "minecraft:wither_skeleton", AbsorptionAmount: 300.0f, Tags: ["SkillMob", "WarpOnly"]}], Health: 0.0f, Attributes: [{Base: 0, Name: "generic.max_health"}], id: "minecraft:villager", Tags: ["Garbage"]}
