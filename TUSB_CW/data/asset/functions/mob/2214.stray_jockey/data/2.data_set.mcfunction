#> asset:mob/2214.stray_jockey/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2214

### idを設定
    data modify storage asset: mob.id set value "cave_spider"
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"ストレイジョッキー","color":"dark_green"}'
    # 名前を表示するか
...
### active_effects
    ...
    data modify storage asset: mob.Passengers[0].id set value "stray"
    data modify storage asset: mob.Passengers[0].HandItems[0] set value {id: "minecraft:bow", Count: 1b, tag: {display: {Name: '{"text":"ストレイの弓","color":"dark_aqua"}'}}}
    data modify storage asset: mob.Passengers[0].HandItems[1] set value {id:"minecraft:tipped_arrow",Count:64b,tag:{display: {Name: '{"text":"ベノムアロー","color":"dark_green"}'},custom_potion_effects:[{id:"minecraft:poison",amplifier:2b,duration:60}],CustomPotionColor:1556992}}
