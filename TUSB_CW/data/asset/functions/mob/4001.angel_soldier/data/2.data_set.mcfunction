#> asset:mob/4001.angel_soldier/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4001
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"エンジェルソルジャー"}'
    # 名前を表示するか
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id:"iron_sword",Count:1b,AttributeModifiers:[]}
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id:"iron_sword",Count:1b}
    # 防具
        # 頭
...
# 演出用AEC
    data modify storage asset: mob.Passengers set value [{id:"area_effect_cloud",duration:100,Particle:"end_rod",Radius:0.1}]