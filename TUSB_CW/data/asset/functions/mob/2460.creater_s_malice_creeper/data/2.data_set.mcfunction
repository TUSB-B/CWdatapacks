#> asset:mob/2460.creater_s_malice_creeper/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"制作者の悪意"}'
    # 名前を表示するか
...
### 爆発関連
    # Fuse
        data modify storage asset: mob.Fuse set value 30
    # 爆発力
        data modify storage asset: mob.ExplosionRadius set value 3
