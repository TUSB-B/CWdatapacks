#> asset:mob/0044.red_baby/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Anger: 32767s, CustomName: '{"text":"ﾚｯﾄﾞﾍﾞｲﾋﾞｰ"}', IsBaby: 1b, Health: 40.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 0}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -459488631, 1580550711, -1693935377, 1559253890], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTg5OTk5YjRkODE0NWJhNjc3YjY5ZmI5MTNiOWE2YTY3MTlkMWM2ZDE3ZWM0ZDNlMjRiZThiMjIxZDY3MjQzIn19fQ=="}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.1d, Name: "generic.movement_speed"}, {Base: 25.0d, Name: "generic.attack_damage"}], id: "minecraft:zombified_piglin", HandItems: [{id: "minecraft:bone", Count: 65b, tag: {Enchantments: [{lvl: 3s, id: "minecraft:fire_aspect"}]}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -929906361, 937117167, -1999267839, 1945924344], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGIyNjY3YTc1YzJjODNiODVjNzBlYjA3YjQ4MzNmZjY3MjEzMmUxZWNhNGFmNjk4NjI0NjVmN2EzYmYzOWE2In19fQ=="}]}}}}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
