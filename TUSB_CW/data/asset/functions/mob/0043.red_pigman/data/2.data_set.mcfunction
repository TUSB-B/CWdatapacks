#> asset:mob/0043.red_pigman/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Anger: 32767s, CustomName: '{"text":"ﾚｯﾄﾞﾋﾟｯｸﾞﾏﾝ"}', Health: 40.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 0}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -459488631, 1580550711, -1693935377, 1559253890], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTg5OTk5YjRkODE0NWJhNjc3YjY5ZmI5MTNiOWE2YTY3MTlkMWM2ZDE3ZWM0ZDNlMjRiZThiMjIxZDY3MjQzIn19fQ=="}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 0.5d, Name: "generic.movement_speed"}, {Base: 10.0d, Name: "generic.attack_damage"}], id: "minecraft:zombified_piglin", HandItems: [{id: "minecraft:golden_sword", Count: 65b, tag: {Enchantments: [{lvl: 3s, id: "minecraft:fire_aspect"}], Damage: 0}}, {id: "minecraft:shield", Count: 65b, tag: {BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "gra", Color: 14}, {Pattern: "ss", Color: 15}, {Pattern: "cbo", Color: 15}], Base: 11}, Damage: 0}}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
