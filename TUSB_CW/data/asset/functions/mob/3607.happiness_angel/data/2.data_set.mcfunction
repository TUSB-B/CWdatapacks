#> asset:mob/3607.happiness_angel/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"幸福の天使"}'
    # 名前を表示するか
            ...
            tag :{\
                SkullOwner: {\
                    Properties: {\
                        textures: [\
                            {\
                                Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2JkMmUxOTllMjc5ZWRjNDgxMThjMTg1OTdhYjgwMWNhMmJhMmY3OGM5NzExNTVkNGQ2MGYxZmI0MGRlNjY0OSJ9fX0="\
                            }\
                        ]\
                    }\
                }\
...
### active_effects
    ...
    #effect一覧
        ...
        # 詳しくはwiki見てね！
    data modify storage asset: mob.active_effects append value {id:"minecraft:slow_falling",amplifier:127,duration:-1,show_particles:0b}
    # 或いは...
