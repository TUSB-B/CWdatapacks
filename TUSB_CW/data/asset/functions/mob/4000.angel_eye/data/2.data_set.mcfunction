#> asset:mob/4000.angel_eye/data/2.data_set
                ...
                tag: {\
                    SkullOwner: {\
                        ...
                        Properties: {\
                            textures: [\
                                {\
                                    Value: ""\
                                }\
                            ]\
                        }, \
                    Name: "エンジェルアイ"\
