#> asset:mob/0050.meega/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Particle: "portal", Radius: 1.5f, CustomName: '{"text":"スクナ"}', Duration: 1000, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 120, id: "minecraft:hunger", amplifier: 3b}, {show_particles: 1b, duration: 120, id: "minecraft:blindness", amplifier: 0b}]}], CustomName: '{"text":"メーガ"}', Health: 40.0f, ArmorItems: [{}, {id: "minecraft:leather_leggings", tag: {display: {color: 4473924}, Damage: 0}}, {id: "minecraft:leather_chestplate", tag: {display: {color: 4473924}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -1864035821, -2130951805, -1654854500, -100401386], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmFlZjIzM2NkNmZkOTE4NzhkNTEzNzY2ZWRjMjNkZjMwODI3OGMwY2U4MDU5NzZlOTY5YzM5NDUxNjRkNmM4In19fQ=="}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.3d, Name: "generic.movement_speed"}, {Base: 30.0d, Name: "generic.attack_damage"}], id: "minecraft:zombie", HandItems: [{}, {}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
