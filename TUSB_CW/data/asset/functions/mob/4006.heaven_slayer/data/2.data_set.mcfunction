#> asset:mob/4006.heaven_slayer/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"ヘブンスレイヤー"}'
    # 名前を表示するか
...
### アイテム
    ...
    # 武器
        ...
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id: "minecraft:shield", Count: 1b, tag: {RepairCost: 1000000000, HideFlags: 32, BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "cr", Color: 12}, {Pattern: "tts", Color: 14}, {Pattern: "bts", Color: 14}, {Pattern: "mr", Color: 14}, {Pattern: "cbo", Color: 15}, {Pattern: "sku", Color: 15}], Base: 15}}}
    # 防具
        # 頭
