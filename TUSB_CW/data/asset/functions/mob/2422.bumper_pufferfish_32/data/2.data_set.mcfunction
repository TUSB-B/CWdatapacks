#> asset:mob/2422.bumper_puffierfish_32/data/2.data_set
...
### idを設定
data modify storage asset: mob.id set value "puffierfish"
...
### Attributes
# 最大体力
data modify storage asset: mob.Attributes append value {Name:generic.max_health, Base:120}
# (近接)攻撃力
