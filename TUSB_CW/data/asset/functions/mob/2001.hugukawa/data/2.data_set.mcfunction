#> asset:mob/2001.hugukawa/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{CustomName: '{"text":"ふぐかわ","color":"black","bold":true}', Health: 700.0f, ArmorItems: [{id: "minecraft:leather_boots", Count: 1b, tag: {display: {color: 0}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}, {lvl: 3s, id: "minecraft:thorns"}], Damage: 0}}, {id: "minecraft:leather_leggings", Count: 1b, tag: {display: {color: 0}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}, {lvl: 3s, id: "minecraft:thorns"}], Damage: 0}}, {id: "minecraft:leather_chestplate", Count: 1b, tag: {display: {color: 0}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}, {lvl: 3s, id: "minecraft:thorns"}], Damage: 0}}, {id: "minecraft:player_head", Count: 1b, tag: {SkullOwner: {Id: [I; 834650244, 546653444, -1151065426, 327564047], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDFiMjY2ZTIwMDBkNjlhMTI2OTcxZGVhMzlmYTk0M2YxMTllODcwOWZlYTE4MTViOTAyYTNjZTZiYWI0MjZjOSJ9fX0="}]}}}}], Attributes: [{Base: 700, Name: "generic.max_health"}, {Base: 1.0d, Name: "generic.knockback_resistance"}, {Base: 0.37d, Name: "generic.movement_speed"}, {Base: 40, Name: "generic.attack_damage"}, {Base: 10, Name: "generic.armor"}], Silent: 1b, id: "minecraft:zombified_piglin", active_effects: [{duration: 10000000, id: "minecraft:invisibility", amplifier: 1b}], HandItems: [{id: "minecraft:pufferfish", Count: 1b, tag: {Enchantments: [{lvl: 20s, id: "minecraft:knockback"}]}}, {id: "minecraft:pufferfish", Count: 1b, tag: {Enchantments: [{}]}}]}], id: "minecraft:villager", Tags: ["Garbage"]}
