#> asset:mob/0001.the_white/data/2.data_set
...
# 名前
data modify storage asset: mob.CustomName set value '{"text":"白き者"}'
# 名前を表示するか
# data modify storage asset: mob.CustomNameVisible set value true
# 死亡時のルートテーブル
data modify storage asset: mob.DeathLootTable set value "usb:entities/silver/tier_1"
# Tags
...
data modify storage asset: mob.Item set value {id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionColor:16777215,custom_potion_effects:[{id:levitation,amplifier:9b,Duration:30}]}}
data modify storage _: _.Passengers append from storage asset: mob
...
# data modify storage asset: mob set value {id:"minecraft:skeleton",DeathLootTable:"usb:entities/white/tier_1",Health:40f,Passengers:[{id:"minecraft:potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionColor:16777215,custom_potion_effects:[{id:levitation,amplifier:9b,Duration:30}]}}}],CustomName:'{"text":"白き者"}',ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:14737632}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:14737632}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:14737632}}},{}],ArmorDropChances:[0.000F,0.000F,0.000F,0.085F],Attributes:[{Name:generic.max_health,Base:40},{Name:generic.follow_range,Base:32},{Name:generic.movement_speed,Base:0.3},{Name:generic.attack_damage,Base:10},{Name:generic.armor,Base:10},{Name:generic.armor_toughness,Base:2}]}