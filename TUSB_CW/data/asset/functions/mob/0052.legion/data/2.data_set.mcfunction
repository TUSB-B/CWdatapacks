#> asset:mob/0052.legion/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Particle: "portal", Radius: 1.5f, CustomName: '{"text":"リョウ"}', Duration: 1000, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 120, id: "minecraft:hunger", amplifier: 10b}, {show_particles: 1b, duration: 120, id: "minecraft:nausea", amplifier: 0b}]}], CustomName: '{"text":"レギオン"}', VillagerProfession: 5, IsBaby: 1b, Health: 40.0f, ArmorItems: [{}, {}, {}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -1239230864, -433568650, -1576611648, 1601599869], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjJjNThhMTQ4N2JjOTUzZmFhNjg3ODk2YWFhZWFjZTI3MWI0YTEyMGUyNzZmYTlkMmQ2ZWE4YjY2NTYxMmMifX19"}]}}}}], Attributes: [{Base: 40.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.0d, Name: "generic.knockback_resistance"}, {Base: 0.2d, Name: "generic.movement_speed"}, {Base: 20.0d, Name: "generic.attack_damage"}], id: "minecraft:zombie", IsVillager: 1b, active_effects: [{show_particles: 0b, duration: 100000, id: "minecraft:levitation", amplifier: -127b}, {show_particles: 0b, duration: 100000, id: "minecraft:jump_boost", amplifier: 4b}], HandItems: [{}, {}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
