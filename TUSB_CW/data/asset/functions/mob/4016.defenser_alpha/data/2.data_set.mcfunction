#> asset:mob/4016.defenser_alpha/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4016
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"拠点防衛装置α"}'
    # 名前を表示するか
...
### Attributes
    ...
    # 移動速度
        data modify storage asset: mob.Attributes append value {Name:generic.movement_speed, Base:0.003}
    # 防具値
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "bow", Count: 65b, tag: {Enchantments:[{id: "power", lvl: 5}]}}
        # オフハンド
            data modify storage asset: mob.HandItems[1] set value {id: "tipped_arrow", Count: 65b, tag: {custom_potion_effects:[{id: "slowness", amplifier: 2b, duration: 100}], CustomPotionColor: 0}}
    # 防具
        # 頭
