#> asset:mob/0036.quietly_read_book/data/2.data_set
...
data modify storage asset: mob set value {Anger: 32767s, CustomName: '{"text":"本を静かに読みたい者"}', Health: 100.0f, ArmorItems: [{id: "minecraft:leather_boots", Count: 65b, tag: {display: {color: 65535}, Damage: 0}}, {id: "minecraft:leather_leggings", Count: 65b, tag: {display: {color: 65535}, Damage: 0}}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 65535}, Damage: 0}}, {id: "minecraft:crafting_table", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 5s, id: "minecraft:fire_protection"}]}}], Attributes: [{Base: 100.0d, Name: "generic.max_health"}, {Base: 20.0d, Name: "generic.attack_damage"}], id: "minecraft:zombified_piglin", active_effects: [{show_particles: 0b, duration: 2000000000,id:"jump_boost", amplifier: 4b}, {show_particles: 0b, duration: 2000000000,id:"strength", amplifier: 4b}], HandItems: [{id: "minecraft:enchanted_book", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 15s, id: "minecraft:knockback"}]}}], CustomNameVisible: 1b}
