#> asset:mob/0802.thanatos/data/2.data_set
...
data modify storage asset: mob set value {Motion: [0.0d, 0.0d, 0.0d], MaxNearbyEntities: 6s, RequiredPlayerRange: 25s, CustomDisplayTile: 1b, SpawnCount: 2s, DisplayState: {Name: "minecraft:air"}, Silent: 1b, Invulnerable: 1b, SpawnData: {entity: {Passengers: [{Passengers: [{CustomName: '{"text":"タナトス"}', Health: 650.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 6881280}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -1880722045, 683360398, -1561990940, 1018580457], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGZjN2UzYzRjNjc0Y2Y4Mzc3M2FjOTI3ZGVkMWE1MzZiYjQ1ZTYzZmIyZTZhOTVhYWExYjYzZWQ3ODZmYzlmIn19fQ=="}]}}}}], Attributes: [{Base: 450.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 0.35d, Name: "generic.movement_speed"}, {Base: 15.0d, Name: "generic.attack_damage"}], id: "minecraft:skeleton", Tags: ["Twins"], active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -4b}], HandItems: [{id: "minecraft:diamond_hoe", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:fire_aspect"}], Damage: 0}}, {id: "minecraft:shield", Count: 65b, tag: {BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "bri", Color: 15}, {Pattern: "cbo", Color: 15}, {Pattern: "flo", Color: 15}, {Pattern: "sc", Color: 15}, {Pattern: "mc", Color: 14}, {Pattern: "cs", Color: 15}, {Pattern: "mr", Color: 9}, {Pattern: "flo", Color: 15}, {Pattern: "bts", Color: 14}, {Pattern: "tts", Color: 14}, {Pattern: "gru", Color: 7}], Base: 14}, Damage: 0}}]}, {Particle: "minecraft:block air", Radius: 1.5f, Duration: 999, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 100, id: "minecraft:slowness", amplifier: 2b}, {show_particles: 1b, duration: 20, id: "minecraft:nausea", amplifier: 2b}, {show_particles: 1b, duration: 20, id: "minecraft:blindness", amplifier: 2b}], Tags: ["SystemEntity"]}, {Particle: "witchMagic", Radius: 0.5f, Duration: 666, id: "minecraft:area_effect_cloud", effects: [{show_particles: 0b, duration: 3, id: "minecraft:invisibility", amplifier: -1b}], Tags: ["SystemEntity"]}], CustomName: '{"text":"タナトス"}', Size: 0, DeathLootTable: "empty", id: "minecraft:magma_cube", AbsorptionAmount: 300.0f, Tags: ["SkillMob", "WarpOnly", "AbyssWarp"], active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -1b}]}, {Passengers: [{Particle: "minecraft:block air", Radius: 1.5f, Duration: 999, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 100, id: "minecraft:slowness", amplifier: 2b}], Tags: ["SystemEntity"]}], CustomName: '{"text":"ケール"}', Health: 650.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 8624292}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; 862076684, 131352711, -1443035484, -1475766753], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTg4ODExM2E5ZWE2OGM4ZDg4N2U3ZDNlZTU0YmFjM2VhNDIxMGJmYmFiNzIwZDhlODRiZTU3MDVjZmFkYzViIn19fQ=="}]}}}}], Attributes: [{Base: 450.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 0.55d, Name: "generic.movement_speed"}, {Base: 10.0d, Name: "generic.attack_damage"}], LeftHanded: 1b, id: "minecraft:skeleton", Tags: ["Twins", "AbyssWarp"], active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -128b}], HandItems: [{id: "minecraft:iron_hoe", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:fire_aspect"}], Damage: 0}}, {id: "minecraft:shield", Count: 65b, tag: {BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "bri", Color: 15}, {Pattern: "cbo", Color: 15}, {Pattern: "flo", Color: 15}, {Pattern: "sc", Color: 15}, {Pattern: "cs", Color: 15}, {Pattern: "mr", Color: 14}, {Pattern: "flo", Color: 15}, {Pattern: "bts", Color: 9}, {Pattern: "tts", Color: 9}, {Pattern: "gru", Color: 7}], Base: 9}, Damage: 0}}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}}, Air: 0s, OnGround: 1b, MaxSpawnDelay: 4200s, PortalCooldown: 0, Rotation: [0.0f, 0.0f], Delay: 39s, FallDistance: 0.0f, DisplayOffset: 0, Pos: [12.5d, 195.0001d, 177.5d], Fire: -1s, UUID: [I; -1, -174723845, -1, -174723846], SpawnRange: 4s, Tags: ["TypeChecked", "SystemEntity", "SpawnerCore", "Spawner"], MinSpawnDelay: 1800s, SpawnPotentials: [{data: {entity: {Passengers: [{Passengers: [{CustomName: '{"text":"タナトス"}', Health: 650.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 6881280}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; -1880722045, 683360398, -1561990940, 1018580457], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGZjN2UzYzRjNjc0Y2Y4Mzc3M2FjOTI3ZGVkMWE1MzZiYjQ1ZTYzZmIyZTZhOTVhYWExYjYzZWQ3ODZmYzlmIn19fQ=="}]}}}}], Attributes: [{Base: 450.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 0.35d, Name: "generic.movement_speed"}, {Base: 15.0d, Name: "generic.attack_damage"}], id: "minecraft:skeleton", active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -4b}], Tags: ["Twins"], HandItems: [{id: "minecraft:diamond_hoe", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:fire_aspect"}], Damage: 0}}, {id: "minecraft:shield", Count: 65b, tag: {BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "bri", Color: 15}, {Pattern: "cbo", Color: 15}, {Pattern: "flo", Color: 15}, {Pattern: "sc", Color: 15}, {Pattern: "mc", Color: 14}, {Pattern: "cs", Color: 15}, {Pattern: "mr", Color: 9}, {Pattern: "flo", Color: 15}, {Pattern: "bts", Color: 14}, {Pattern: "tts", Color: 14}, {Pattern: "gru", Color: 7}], Base: 14}, Damage: 0}}]}, {Particle: "minecraft:block air", Radius: 1.5f, Duration: 999, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 100, id: "minecraft:slowness", amplifier: 2b}, {show_particles: 1b, duration: 20, id: "minecraft:nausea", amplifier: 2b}, {show_particles: 1b, duration: 20, id: "minecraft:blindness", amplifier: 2b}], Tags: ["SystemEntity"]}, {Particle: "witchMagic", Radius: 0.5f, Duration: 666, id: "minecraft:area_effect_cloud", effects: [{show_particles: 0b, duration: 3, id: "minecraft:invisibility", amplifier: -1b}], Tags: ["SystemEntity"]}], CustomName: '{"text":"タナトス"}', Size: 0, DeathLootTable: "empty", id: "minecraft:magma_cube", AbsorptionAmount: 300.0f, active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -1b}], Tags: ["SkillMob", "WarpOnly", "AbyssWarp"]}, {Passengers: [{Particle: "minecraft:block air", Radius: 1.5f, Duration: 999, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 100, id: "minecraft:slowness", amplifier: 2b}], Tags: ["SystemEntity"]}], CustomName: '{"text":"ケール"}', Health: 650.0f, ArmorItems: [{}, {}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {display: {color: 8624292}, Damage: 0}}, {id: "minecraft:player_head", Count: 65b, tag: {SkullOwner: {Id: [I; 862076684, 131352711, -1443035484, -1475766753], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTg4ODExM2E5ZWE2OGM4ZDg4N2U3ZDNlZTU0YmFjM2VhNDIxMGJmYmFiNzIwZDhlODRiZTU3MDVjZmFkYzViIn19fQ=="}]}}}}], Attributes: [{Base: 450.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.5d, Name: "generic.knockback_resistance"}, {Base: 0.55d, Name: "generic.movement_speed"}, {Base: 10.0d, Name: "generic.attack_damage"}], LeftHanded: 1b, id: "minecraft:skeleton", active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 1000000, id: "minecraft:levitation", amplifier: -128b}], Tags: ["Twins", "AbyssWarp"], HandItems: [{id: "minecraft:iron_hoe", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:fire_aspect"}], Damage: 0}}, {id: "minecraft:shield", Count: 65b, tag: {BlockEntityTag: {id: "minecraft:banner", Patterns: [{Pattern: "bri", Color: 15}, {Pattern: "cbo", Color: 15}, {Pattern: "flo", Color: 15}, {Pattern: "sc", Color: 15}, {Pattern: "cs", Color: 15}, {Pattern: "mr", Color: 14}, {Pattern: "flo", Color: 15}, {Pattern: "bts", Color: 9}, {Pattern: "tts", Color: 9}, {Pattern: "gru", Color: 7}], Base: 9}, Damage: 0}}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}}, weight: 1}]}
