#> asset:mob/0101.triangle_sama_on_bat/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{CustomName: '{"text":"三角様"}', Health: 200.0f, ArmorItems: [{Count: 65b, id: "minecraft:leather_boots", tag: {RepairCost: 1000000000, display: {color: 8388736, Name: '{"text":"チェイサーの靴"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {Count: 65b, id: "minecraft:leather_leggings", tag: {RepairCost: 1000000000, display: {color: 8388736, Name: '{"text":"チェイサーのズボン"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {Count: 65b, id: "minecraft:leather_chestplate", tag: {RepairCost: 1000000000, display: {color: 8388736, Name: '{"text":"チェイサーの服"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {Count: 65b, id: "minecraft:dragon_egg", tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:blast_protection"}]}}], Attributes: [{Base: 200.0d, Name: "generic.max_health"}, {Base: 1.0d, Name: "generic.knockback_resistance"}], id: "minecraft:skeleton", active_effects: [{show_particles: 0b, duration: 2000000000, id: "minecraft:invisibility", amplifier: 1b}], CustomNameVisible: 1b, HandItems: [{Count: 65b, id: "minecraft:bow", tag: {RepairCost: 1000000000, display: {Name: '{"text":"チェイサーの弓"}'}, Enchantments: [{lvl: 10s, id: "minecraft:power"}, {lvl: 15s, id: "minecraft:punch"}], Damage: 0}}]}], Health: 40.0f, Attributes: [{Base: 40.0d, Name: "generic.max_health"}], id: "minecraft:bat"}], DeathTime: 19s, Health: 0.0f, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
