#> asset:mob/2634.sakura/data/2.data_set
...
# AssetIdを設定
    data modify storage asset: mob.AssetId set value 2634

# idを設定
    data modify storage asset: mob.id set value "chicken"
...
# 体力等nbtを設定(コメントアウトを解除して設定)
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"桜の花びら","bold":true,"color": "#ffdbed"}'
    # 名前を表示するか
    ...
    # Tags
        data modify storage asset: mob.Tags set value [FloatingRequired]
    # Team
...
# active_effects
    ...
    data modify storage asset: mob.Passengers append value {\
        ...
        Tags:[TypeChecked],\
        effects:[\
                    {id:"minecraft:slowness",amplifier:3b,duration:100},\
                    {id:"minecraft:poison",amplifier:3b,duration:160},\
                    {id:"minecraft:mining_fatigue",amplifier:0b,duration:160},\
                    {id:"minecraft:instant_damage",amplifier:2b,duration:20},\
                ],\
        CustomName:'{"text":"桜の花びら","bold":true,"color": "#ffdbed"}'\
    }