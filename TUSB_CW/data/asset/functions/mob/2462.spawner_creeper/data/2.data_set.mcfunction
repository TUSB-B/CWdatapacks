#> asset:mob/2462.spawner_creeper/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2460

### idを設定
    data modify storage asset: mob.id set value "creeper"

### 体力等nbtを設定
    # 体力
        data modify storage asset: mob.Health set value 100
    # 緩衝体力
        # data modify storage asset: mob.AbsorptionAmount set value 
    # AIを持っていないか
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"スポナークリーパー"}'
    # 名前を表示するか
    ...
    # Tags
        # data modify storage asset: mob.Tags set value [TypeChecked,Enemy]
    # Team
...
### 爆発関連
    # Fuse
        data modify storage asset: mob.Fuse set value 300
    # 爆発力
        data modify storage asset: mob.ExplosionRadius set value 10
    # 帯電
        data modify storage asset: mob.powered set value true
...
### アイテム
    ...
    # 防具
        # 頭
            data modify storage asset: mob.ArmorItems[3] set value {id:"leather_helmet",Count:1b,tag:{AttributeModifiers:[{}],Enchantments:[{id:blast_protection,lvl:10}],Unbreakable:true,display:{Lore:['"§r§2シュー...どーん！"'],Name:'"§r§2§lクリーパーの帽子"',color:34816}}}
        # 胴
...
### active_effects
    ...
    #effect一覧
        ...
        # 詳しくはwiki見てね！
        # 効果時間を-1に設定すると無限になる
    data modify storage asset: mob.active_effects set value [\
        {id: "minecraft:absorption", amplifier: 99b, duration: 100, show_particles: 1b}\
    ]

# 騎乗スポナー
    data modify storage asset: mob.Passengers set value [\
        {\
            id:"spawner_minecart",\
            SpawnCount:1b,\
            SpawnRange:6,\
            ...
            MaxSpawnDelay:10,\
            SpawnPotentials:[\
                {weight:3,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:2460}}]}}},\
                {weight:2,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:2461}}]}}},\
                {weight:1,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:224}}]}}}],\
            Invulnerable:true\
        }\
    ]