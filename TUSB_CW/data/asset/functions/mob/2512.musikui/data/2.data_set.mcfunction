#> asset:mob/2512.musikui/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2512

### idを設定
    data modify storage asset: mob.id set value "silverfish"
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"虫食いカボチャ"}'
    # 名前を表示するか
