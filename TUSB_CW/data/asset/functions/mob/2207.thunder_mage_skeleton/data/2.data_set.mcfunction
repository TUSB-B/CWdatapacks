#> asset:mob/2207.thunder_mage_skeleton/data/2.data_set
...
# AssetIdを設定
    data modify storage asset: mob.AssetId set value 2207
...
# 体力等nbtを設定(コメントアウトを解除して設定)
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"§6サンダーメイジスケルトン","bold":true}'
    # 名前を表示するか
...
# アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id:carrot_on_a_stick,Count:1b,tag:{RepairCost: 1000000000, Damage: 0, display: {Name: '{"text":"§4§lレッドキャロット"}'}, Enchantments: [{lvl: 7s, id: "minecraft:sharpness"}, {lvl: 7s, id: "minecraft:smite"}, {lvl: 7s, id: "minecraft:bane_of_arthropods"}, {lvl: 1s, id: "minecraft:knockback"}, {lvl: 7s, id: "minecraft:fire_aspect"}]}}
        # オフハンド
