#> asset:mob/2440.danger_cat/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"あぶない猫"}'
    # 名前を表示するか
...
### アイテム
    data modify storage asset: mob.ArmorItems set value [{id:"leather_boots",Count:1b,tag:{Enchantments:[{id:"blast_protection",lvl:10s}]}},{},{},{}]
...
data modify storage asset: mob.Passengers append value {\
    ...
    CustomName:'{"text":"あぶないスポナー"}'\
}
data modify storage asset: mob.Passengers[0].SpawnPotentials set value [{\
    weight: 1,\
    data: {\
        entity: {\
            id: "minecraft:item",\
