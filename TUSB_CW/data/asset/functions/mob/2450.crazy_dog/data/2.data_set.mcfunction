#> asset:mob/2450.crazy_dog/data/2.data_set
...
# AssetIdを設定
    data modify storage asset: mob.AssetId set value 2450

# idを設定
    data modify storage asset: mob.id set value "wolf"
...
# 体力等nbtを設定(コメントアウトを解除して設定)
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"§4狂犬","bold":true}'
    # 名前を表示するか
...
# アイテム
    ...
    data modify storage asset: mob.Passengers append value {CustomName: '{"text":"§2狂犬病ウイルス","bold":true}', IsBaby: 1b, Health: 999.0f, Attributes: [{Base: 100.0d, Name: "generic.max_health"},{Base: 20.0d, Name: "generic.attack_damage"}],  id: "minecraft:zombie",Tags:["RidingRequired"],ArmorDropChances:[0.0F,0.0F,0.0F,0.0F],ArmorItems:[{},{},{},{id:conduit,Count:1b}],active_effects:[{id: "minecraft:invisibility", amplifier: 127b, duration: -1, show_particles: 1b},{duration: -1, id: "minecraft:resistance", amplifier: 127b}]}

    data modify storage asset: mob.Passengers[0].Passengers append value {Tags:[RidingRequired],Particle:"ash", Radius: 3f, ReapplicationDelay: 0,CustomName: '{"text":"§2狂犬病ウイルス","bold":true}', RadiusOnUse: 0.0f, Duration: 32767, id: "minecraft:area_effect_cloud", effects: [\
    {duration: 20, id: "minecraft:wither", amplifier: 2b},\
    {duration: 20, id: "minecraft:instant_damage", amplifier: 1b},\
    {duration: 300, id: "minecraft:nausea", amplifier: 0b},\
    {duration: 100, id: "minecraft:slowness", amplifier: 1b}\
    ]}
