#> asset:mob/4017.defenser_beta/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 4017

### idを設定
    data modify storage asset: mob.id set value "guardian"
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"拠点防衛装置β"}'
    # 名前を表示するか
