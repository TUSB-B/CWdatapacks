...
data modify storage asset: mob set value {NoGravity:1b,Silent:1b,Passengers:[{id:"minecraft:shulker",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired"],Passengers:[{id:"minecraft:shulker",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired"],Passengers:[{id:"minecraft:shulker",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired"],Passengers:[{id:"minecraft:shulker",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired"],Passengers:[{id:"minecraft:shulker",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired"],Passengers:[{id:"minecraft:allay",Silent:1b,NoAI:1b,Health:1f,Tags:["RidingRequired"],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],CustomName:'{"text":"地下水路の柱","color":"dark_green","bold":true}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.5f,-0.5f,-0.5f],scale:[1f,6f,1f]},block_state:{Name:"minecraft:mossy_stone_bricks"}}
