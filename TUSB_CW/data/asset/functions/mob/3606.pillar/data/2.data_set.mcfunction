...
data modify storage asset: mob set value {id:"block_display",PortalCooldown:0,NoGravity:1b,Silent:1b,DeathLootTable:"empty",Tags:["Boss.TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired","TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired","TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired","TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RiderRequired","RidingRequired","TableFirst.Pillar"],Passengers:[{id:"minecraft:shulker",DeathTime:19,DeathLootTable:"empty",Silent:1b,NoAI:1b,Health:1f,AttachFace:0b,Tags:["RidingRequired","TableFirst.Pillar"],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:1}]}],CustomName:'{"text":"地下水路の柱","color":"dark_green","bold":true}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.5f,-0.5f,-0.5f],scale:[1f,6.5f,1f]},block_state:{Name:"minecraft:mossy_stone_bricks"}}
# ### 体力等nbtを設定
#     # 体力
