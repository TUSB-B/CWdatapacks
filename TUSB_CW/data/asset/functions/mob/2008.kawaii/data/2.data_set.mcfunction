#> asset:mob/2008.kawaii/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2008

### idを設定
    data modify storage asset: mob.id set value "drowned"
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"流体に沈みし可愛いもの","color":"aqua"}'
    # 名前を表示するか
