#> asset:mob/4301.full_color_eye/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Particle: "end_rod", Radius: 1.0f, Passengers: [{CustomName: '{"text":"Grumm"}', Health: 600.0f, IsBaby: 1b, ArmorItems: [{}, {}, {}, {id: "minecraft:player_head", Count: 1b, tag: {SkullOwner: {Id: [I; -1267115575, -783662189, -1494645861, -45507850], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmZkOGM3YjcyOWRiYWQ0M2I0ZWRjNzhjNGU5MWQyOGNiN2ZhMmYxY2E4OWRiNzM0OTBlYmUxMjU0MmJhIn19fQ=="}]}}}}], Attributes: [{Base: 600, Name: "generic.max_health"}], Silent: 1b, id: "minecraft:zombie", active_effects: [{Duration: 200000, Id: 10, amplifier: 2b}, {Duration: 200000, Id: 11, amplifier: 2b}, {show_particles: 0b, Duration: 200000, Id: 14, amplifier: 2b}]}], Potion: "minecraft:empty", Duration: 2000000, id: "minecraft:area_effect_cloud", effects: [{Duration: 300, Id: 2, amplifier: 2b}, {Duration: 300, Id: 4, amplifier: 2b}, {Duration: 40, Id: 7, amplifier: 2b}, {Duration: 300, Id: 9, amplifier: 2b}, {Duration: 300, Id: 17, amplifier: 10b}, {Duration: 300, Id: 19, amplifier: 10b}, {Duration: 300, Id: 20, amplifier: 10b}, {Duration: 280, Id: 33, amplifier: 10b}]}], CustomName: '[{"text":"フ","color":"gold","bold":true},{"text":"ル","color":"dark_red","bold":true},{"text":"カ","color":"blue","bold":true},{"text":"ラ","color":"dark_purple","bold":true},{"text":"ー","color":"dark_blue","bold":true},{"text":"ア","color":"yellow","bold":true},{"text":"イ","color":"aqua"}]', Health: 300.0f, Attributes: [{Base: 300, Name: "generic.max_health"}, {Base: 30, Name: "generic.follow_range"}, {Base: 40, Name: "generic.attack_damage"}], Silent: 1b, id: "minecraft:vex", Tags: ["SkillMob", "WarpOnly"], active_effects: [{show_particles: 0b, Duration: 200000, Id: 10, amplifier: 2b}, {show_particles: 0b, Duration: 200000, Id: 11, amplifier: 2b}, {show_particles: 0b, Duration: 200000, Id: 14, amplifier: 1b}]}], id: "minecraft:villager", Tags: ["Garbage"]}
