#> asset:mob/2520.ika_ikaga/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{id: "minecraft:guardian",Tags:["RiderRequired"],DeathLootTable:"empty",CustomNameVisible: 1b,NoGravity:1b,Silent:1b,Health:10f,Motion:[0.0,0.15,0.0],Passengers:[{id:"minecraft:glow_squid",CustomNameVisible:1b,Health:10f,Passengers:[{id:"minecraft:guardian",Tags:["RidingRequired"],NoGravity:1b,Health:10f,Passengers:[{id:"minecraft:area_effect_cloud",Tags:["RidingRequired"],Particle:"glow_squid_ink",CustomName:'{"text":"烏賊は如何？","bold":true,"italic":false}',DeathLootTable:"empty",CustomNameVisible: 1b,Radius:1f,Duration:60}],CustomName:'{"text":"烏賊は如何？","bold":true,"italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.follow_range,Base:1000}]}],DeathLootTable:"empty",CustomNameVisible: 1b,CustomName:'{"text":"烏賊は如何？","bold":true,"italic":false}',active_effects:[{id:"minecraft:regeneration",amplifier:10b,duration:-1}],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.follow_range,Base:10}]}],DeathLootTable:"empty",CustomNameVisible: 1b,CustomName:'{"text":"烏賊は如何？","bold":true,"italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.follow_range,Base:1000}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"},id: "minecraft:villager"}
