#> asset:mob/2631.grimoire/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{id: "minecraft:vex",DeathLootTable:"empty",Glowing:1b,Health:40f,Passengers:[{id:"minecraft:spawner_minecart",Silent:1b,Invulnerable:1b,CustomNameVisible:1b,CustomDisplayTile:1b,DisplayOffset:5,SpawnCount:3,SpawnRange:5,Delay:80,MinSpawnDelay:80,MaxSpawnDelay:80,MaxNearbyEntities:100,RequiredPlayerRange:15,CustomName:'{"text":"魔導書","color":"dark_purple","bold":true,"italic":false}',DisplayState:{Name:"minecraft:enchanting_table"},SpawnPotentials:[{weight:1,data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:experience_orb",Age:5950,Motion:[0.0,0.5,0.0],Passengers:[{id:"minecraft:area_effect_cloud",Particle:"enchant",CustomNameVisible:1b,Radius:4f,Duration:50,effects:[{id:"minecraft:nausea",amplifier:1b,duration:60,show_particles:0b},{id:"minecraft:darkness",amplifier:1b,duration:60,show_particles:0b}],CustomName:'{"text":"⚠ 英知の結晶 ⚠","color":"light_purple","bold":true,"italic":false}'}]}}},{weight:1,data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:vex",Silent:1b,Glowing:1b,Health:10f,HandItems:[{id:"minecraft:book",Count:1b},{id:"minecraft:book",Count:1b}],HandDropChances:[-327.670F,-327.670F],ArmorItems:[{},{},{},{id:"minecraft:bookshelf",Count:1b}],ArmorDropChances:[0.085F,0.085F,0.085F,-327.670F],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1},{id:"minecraft:wither",amplifier:1b,duration:-1}],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.follow_range,Base:100},{Name:generic.attack_damage,Base:10}]}}}]},{id:"minecraft:guardian",Silent:1b,Health:70f,DeathLootTable:"empty",CustomName:'{"text":"魔導書のレーザービーム","color":"dark_purple","bold":true,"italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:70}]},{id:"minecraft:guardian",Silent:1b,Health:70f,DeathLootTable:"empty",CustomName:'{"text":"魔導書のレーザービーム","color":"dark_purple","bold":true,"italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:70}]},{id:"minecraft:guardian",Silent:1b,Health:70f,DeathLootTable:"empty",CustomName:'{"text":"魔導書のレーザービーム","color":"dark_purple","bold":true,"italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:70}]}],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:40},{Name:generic.follow_range,Base:100},{Name:generic.attack_damage,Base:0}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"},id: "minecraft:villager"}
