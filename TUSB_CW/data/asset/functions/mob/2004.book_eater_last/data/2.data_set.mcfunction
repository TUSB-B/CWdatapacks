#> asset:mob/2004.book_eater_last/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"本を静かに貪る者 下巻"}'
    # 名前を表示するか
...
### アイテム
    data modify storage asset: mob.HandItems set value [\
        {id:"minecraft:enchanted_book",Count:1b,tag:{Enchantments:[{}]}},\
        {id:"minecraft:enchanted_book",Count:1b,tag:{Enchantments:[{}]}}\
    ]
    ...
    data modify storage asset: mob.ArmorItems[].tag.display.color set value 3145881
...
### 本を貪る者のオーラ
    data modify storage asset: mob.Passengers append value {\
        ...
        Radius:1f,\
        Duration:30,\
        effects:[{id:"minecraft:slowness",amplifier:5b,duration:40}],\
