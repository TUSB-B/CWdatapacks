#> asset:mob/2530.samayou_ghost/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2530
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"彷徨う怨霊","color":"dark_aqua"}'
    # 名前を表示するか
...
### Attributes
    ...
    # Attribute Modifierというものも使用可能。ただし、UUIDを指定する必要がある(めんどい)
        ...
        data modify storage asset: mob.Passengers append value {id:"minecraft:area_effect_cloud",Tags:["RidingRequired", "TypeChecked"],Particle:"soul_fire_flame",CustomName:'{"text":"彷徨う怨霊","color":"dark_aqua"}',DeathLootTable:"empty",CustomNameVisible: 1b,Radius:2f,Duration:32767,effects: [{id: "minecraft:mining_fatigue",amplifier: 0b,duration: 60}]}
