#> asset:mob/2510.jasdf/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2510
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"JASDF"}'
    # 名前を表示するか
...
### Attributes
    ...
    # 防具値
        data modify storage asset: mob.Attributes append value {Name:generic.armor, Base:14}
    # 防具強度
...
### アイテム
    ...
    # 防具
        ...
        # 胴
            data modify storage asset: mob.ArmorItems[2] set value {id: "iron_chestplate", Count: 65b, tag: {Enchantments: [{id: "projectile_protection", lvl: 10s}]}}
        # 脚
...
### active_effects
    ...
    #effect一覧
        ...
        # 詳しくはwiki見てね！
        # 効果時間を-1に設定すると無限になる
    data modify storage asset: mob.active_effects append value {id: "minecraft:slow_falling", amplifier: 127b, duration: -1, show_particles: 0b}