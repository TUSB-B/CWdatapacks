#> asset:mob/0110.bow_ninja/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{CustomName: '{"text":"ユミ・ニンジャ"}', Passengers: [{Item: {Count: 1b, id: "minecraft:splash_potion", tag: {custom_potion_effects: [{duration: 10, id: "minecraft:strength", amplifier: -127b}, {duration: 10, id: "minecraft:instant_damage", amplifier: 1b}, {duration: 350, id: "minecraft:blindness", amplifier: 1b}], Potion: "minecraft:strong_healing"}}, Potion: {Count: 1b, id: "minecraft:splash_potion", tag: {custom_potion_effects: [{duration: 10, id: "minecraft:strength", amplifier: -127b}, {duration: 10, id: "minecraft:instant_damage", amplifier: 1b}, {duration: 350, id: "minecraft:blindness", amplifier: 1b}], Potion: "minecraft:strong_healing"}}, id: "minecraft:potion"}], Health: 80.0f, ArmorItems: [{Count: 65b, id: "minecraft:leather_boots", tag: {display: {color: 0}, Damage: 0}}, {Count: 65b, id: "minecraft:leather_leggings", tag: {display: {color: 0}, Damage: 0}}, {Count: 65b, id: "minecraft:leather_chestplate", tag: {display: {color: 0}, Damage: 0}}, {Count: 65b, id: "minecraft:player_head", tag: {SkullOwner: {Id: [I; -363679670, -969850866, -1360387133, -2112977463], Properties: {textures: [{Value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDBiZmNkZjNjYjcxNzQyNTNkMzdlOGQzNDVhODU4MmY1Zjc0ZDdmNTljN2M3OTU3YjcwYzJhYmM3NzQ1Y2E3In19fQ=="}]}}}}], Attributes: [{Base: 80.0d, Name: "generic.max_health"}, {Base: 48.0d, Name: "generic.follow_range"}, {Base: 0.1d, Name: "generic.knockback_resistance"}, {Base: 0.5d, Name: "generic.movement_speed"}, {Base: 5.0d, Name: "generic.attack_damage"}], id: "minecraft:skeleton", active_effects: [{show_particles: 0b, duration: 1000000, id: "minecraft:jump_boost", amplifier: 2b}], Tags: ["SkillMob", "WarpOnly"], HandItems: [{Count: 65b, id: "minecraft:bow", tag: {RepairCost: 1000000000, Enchantments: [{lvl: 3s, id: "minecraft:power"}, {lvl: 1s, id: "minecraft:punch"}], Damage: 0}}, {}]}], DeathTime: 19s, Health: 0.0f, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, id: "minecraft:invisibility", amplifier: 0b}]}
