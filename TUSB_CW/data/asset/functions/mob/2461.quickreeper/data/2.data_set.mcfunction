#> asset:mob/2461.quickreeper/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2461
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"クイックリーパー"}'
    # 名前を表示するか
...
### 爆発関連
    # Fuse
        data modify storage asset: mob.Fuse set value 5
    # 爆発力
        data modify storage asset: mob.ExplosionRadius set value 2
