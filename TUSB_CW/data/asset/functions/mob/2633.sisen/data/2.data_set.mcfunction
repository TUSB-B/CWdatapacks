#> asset:mob/2633.sisen/data/2.data_set
...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Passengers: [{CustomName: '{"text":"視線"}', Health: 20.0f, Attributes: [{Base: 160.0d, Name: "generic.max_health"}, {Base: 4d, Name: "generic.attack_damage"}, {Base: 80.0d, Name: "generic.follow_range"}], id: "minecraft:guardian", active_effects: [{show_particles: 0b, duration: 2147483647, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:glowing", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:levitation", amplifier: -1b}]}, {CustomName: '{"text":"視線"}', Health: 20.0f, Attributes: [{Base: 160.0d, Name: "generic.max_health"}, {Base: 4d, Name: "generic.attack_damage"}, {Base: 80.0d, Name: "generic.follow_range"}], id: "minecraft:guardian", active_effects: [{show_particles: 0b, duration: 2147483647, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:glowing", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:levitation", amplifier: -1b}]}, {CustomName: '{"text":"視線"}', Health: 20.0f, Attributes: [{Base: 160.0d, Name: "generic.max_health"}, {Base: 4d, Name: "generic.attack_damage"}, {Base: 80.0d, Name: "generic.follow_range"}], id: "minecraft:guardian", active_effects: [{show_particles: 0b, duration: 2147483647, id: "minecraft:invisibility", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:glowing", amplifier: 127b}, {show_particles: 0b, duration: 2147483647, id: "minecraft:levitation", amplifier: -1b}]}]}], CustomName: '{"text":"不発弾"}', LifeTime: 30, Life: 2, id: "minecraft:firework_rocket"}], Health: 0.0f, Attributes: [{Base: 0.0d, Name: "generic.max_health"}], Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
