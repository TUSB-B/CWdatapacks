#> asset:mob/2206.snow_bow/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"雪弓"}'
    # 名前を表示するか
...
### アイテム
    data modify storage asset: mob.HandItems set value [\
        {id:"minecraft:bow",Count:1b,tag:{Enchantments:[{id:"minecraft:power",lvl:3s}]}},\
        {id:"minecraft:tipped_arrow",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:slowness",amplifier:5b,duration:30},{id:"minecraft:mining_fatigue",amplifier:3b,duration:40}],CustomPotionColor:1048575}}]
...
### 雪水
    data modify storage asset: mob.Passengers append value {\
        ...
        Item:{\
            ...
            Count:1b,\
            tag:{\
                CustomPotionColor:1048575,\
                custom_potion_effects:[\
                    {id:"minecraft:slowness",amplifier:5b,duration:400},\
                    {id:"minecraft:mining_fatigue",amplifier:1b,duration:400}\
                ],\
            Enchantments:[{}]\
        }}\
    }
...
### 雪銃
    data modify storage asset: mob.Passengers append value {id:"minecraft:guardian"}
    ### 体力等nbtを設定
    # 体力
        data modify storage asset: mob.Passengers[1].Health set value 100
    # 名前
        data modify storage asset: mob.Passengers[1].CustomName set value '{"text":"雪銃"}'

### Attributes
    # 最大体力
        data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.max_health, Base:100}
    # (近接)攻撃力
        data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.attack_damage, Base:10}
    # 移動速度
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.movement_speed, Base:0.2}
    # 防具値
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.armor, Base:20}
    # 防具強度
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.armor_toughness, Base:12}
    # ノックバック耐性(0~1)
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.knockback_resistance, Base:1}
    # 索敵範囲
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.follow_range, Base:32}
    # 攻撃のノックバック(0~5)
        # data modify storage asset: mob.Passengers[1].Attributes append value {Name:generic.attack_knockback, Base:1}
