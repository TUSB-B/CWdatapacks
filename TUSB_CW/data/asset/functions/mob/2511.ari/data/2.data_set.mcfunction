#> asset:mob/2511.ari/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2511
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"ｱﾘ","color":"gray"}'
    # 名前を表示するか
...
### アイテム
    ...
    # 武器
        # メインハンド
            data modify storage asset: mob.HandItems[0] set value {id: "minecraft:emerald_block", Count: 1b,tag: {display: {Name: '{"text":"メロン味の飴,"color":"green"}'}, Enchantments: [{lvl: 3s, id: "minecraft:knockback"}]}}
        # オフハンド
