#> asset:mob/4003.angel_summoner/data/2.data_set
...
# スポナー
    data modify storage asset: mob.Passengers set value [\
      {\
            ...
            MaxSpawnDelay:1600,\
            SpawnPotentials:[\
                {weight:1,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:4000}}]}}}],\
            Invulnerable:true\
        },\
        {\
            id:"spawner_minecart",\
            ...
            MaxSpawnDelay:800,\
            SpawnPotentials:[\
                {weight:4,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:4004}}]}}},\
                {weight:3,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:4005}}]}}},\
                {weight:2,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:4006}}]}}},\
                {weight:1,data:{entity:{id:"villager",Passengers:[{id:"marker",Tags:[Spawn],data:{AssetId:4002}}]}}}],\
            Invulnerable:true\
        }\
    ]