#> asset:mob/2471.toughness/data/2.data_set
...
### AssetIdを設定
    data modify storage asset: mob.AssetId set value 2471
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"タフネスブレイズ","bold":true,"color":"gold"}'
    # 名前を表示するか
...
### active_effects
    ...
    #effect一覧
        ...
        # 詳しくはwiki見てね！
        # 効果時間を-1に設定すると無限になる
    data modify storage asset: mob.active_effects append value {id: "minecraft:regeneration", amplifier: 1b, duration: -1, show_icon: 1b,show_particles: 0b}