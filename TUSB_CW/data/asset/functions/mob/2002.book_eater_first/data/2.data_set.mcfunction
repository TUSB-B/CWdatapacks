#> asset:mob/2002.book_eater_first/data/2.data_set
...
### 体力等nbtを設定
    ...
    # 名前
        data modify storage asset: mob.CustomName set value '{"text":"本を静かに貪る者 上巻"}'
    # 名前を表示するか
...
### Attributes
    # 最大体力
        data modify storage asset: mob.Attributes append value {Name:generic.max_health, Base:75}
    # (近接)攻撃力
    ...
    # ノックバック耐性(0~1)
        data modify storage asset: mob.Attributes append value {Name:generic.knockback_resistance, Base:4}
    # 索敵範囲
...
### アイテム
    ...
    data modify storage asset: mob.ArmorItems set value [\
        ...
        {id:"minecraft:bookshelf",Count:1b}\
    ]
    data modify storage asset: mob.ArmorItems[].tag.display.color set value 5243135
...
### 本を貪る者のオーラ
    data modify storage asset: mob.Passengers append value {\
        ...
        Radius:1f,\
        Duration:30,\
        effects:[{id:"minecraft:slowness",amplifier:3b,duration:40}],\
        CustomName:'{"text":"貪る者のオーラ"}'\
    }
