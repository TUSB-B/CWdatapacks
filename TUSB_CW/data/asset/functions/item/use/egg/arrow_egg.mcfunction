...
### 元ＮＢＴ
data modify storage asset:item item.tag set value {EntityTag: {DeathTime: 19s, ArmorItems: [], DeathLootTable: "usb:signs/arrow", id: "minecraft:skeleton", NoAI: 1b, active_effects: [{duration: 100, id: "instant_health", amplifier: 5b, show_particles: 0b}, {duration: 100, id: "invisibility", amplifier: 0b, show_particles: 0b}], Tags: ["RewardEgg", "TypeChecked"], HandItems: []}, RepairCost: 1000000000, HideFlags: 16, CanPlaceOn: ["#minecraft:all"], display: {Lore: ['{"text":"§f矢が64本収納された筒。"}'], Name: '{"text":"§f矢筒"}'}, Enchantments: []}