                            ...
                            Offers:\
                                {\
                                    ...
                                    [\
                                        ...
                                        {\ 
                                            buy:{id:"paper",Count:1,tag:{display:{Name:'{"text":"§d§l交換チケット・雑貨[梅]","color":"aqua"}'},HideFlags:1,RepairCost: 1000000000,Enchantments:[{id:"minecraft:mending",lvl:2s}]}},\
                                        ...
                                        {\ 
                                            buy:{id:"paper",Count:6,tag:{display:{Name:'{"text":"§d§l交換チケット・雑貨[梅]","color":"aqua"}'},HideFlags:1,RepairCost: 1000000000,Enchantments:[{id:"minecraft:mending",lvl:2s}]}},\
                                        ...
                                        {\ 
                                            buy:{id:"paper",Count:4,tag:{display:{Name:'{"text":"§d§l交換チケット・雑貨[梅]","color":"aqua"}'},HideFlags:1,RepairCost: 1000000000,Enchantments:[{id:"minecraft:mending",lvl:2s}]}},\
