...
summon villager ~ ~ ~ {\
                            Invulnerable:1b,\
                            CustomName:'{"text":"§l特殊チケット交換屋 -§d梅§r§l-"}',\
                            ...
                            Offers:\
                                {\
                                    ...
                                    [\
                                        ...
                                        {\ 
                                            buy:{id:"paper",Count:6,tag:{display:{Name:'{"text":"§d§l交換チケット・特殊[梅]","color":"aqua"}'},HideFlags:1,RepairCost: 1000000000,Enchantments:[{id:"minecraft:mending",lvl:2s}]}},\
                                        ...
                                        {\ 
                                            buy:{id:"paper",Count:5,tag:{display:{Name:'{"text":"§d§l交換チケット・特殊[梅]","color":"aqua"}'},HideFlags:1,RepairCost: 1000000000,Enchantments:[{id:"minecraft:mending",lvl:2s}]}},\
